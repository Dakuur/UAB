...
def ibex35(companies_info, prices):
    total = 0
    for company_info, price in zip(companies_info, prices):
        total += company_info[2] * price
    return total

prices_string = input("Introduir preus de cotització: ")
prices = list(map(float, prices_string.split(',')))
print(ibex35(llista_companyies, prices))